...
T = 1200;                         % Time duration of the evolution, can adjust this
dt = 0.02;                     %to see the difference between fast and slow move
M = T/dt                       % Total No. of steps in the evolution
                                % Time step
