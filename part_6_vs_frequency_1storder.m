...
T = 200;                       % Time duration of the evolution, can adjust this to see the difference between fast and slow move
dt = 0.02;
M = T/dt
...
A = 0.001;
wwidth = 4*pi/T;
warray = linspace(0.5-wwidth,0.5+wwidth,130);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('$\frac{\omega_{nm}-\omega_{i}}{2\pi} T$','Interpreter','latex','FontSize',16)
ylabel('${P_{n\leftarrow m}}$','Interpreter','latex','FontSize',16)
legend('Numerical')